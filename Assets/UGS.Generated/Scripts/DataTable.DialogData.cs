...
namespace DataTable
{
    ...
    { 
        ...
        public delegate void OnLoadedFromGoogleSheets(List<DialogData> loadedList, Dictionary<string, DialogData> loadedDictionary);

        static bool isLoaded = false;
        static string spreadSheetID = "1bYLkGCQlm6YZeaVqFQ97hwpNjzjzLIdVvqCNYFtR3ug"; // it is file id
        static string sheetID = "1282050724"; // it is sheet id
        static UnityFileReader reader = new UnityFileReader();

/* Your Loaded Data Storage. */
    
        public static Dictionary<string, DialogData> DialogDataMap = new Dictionary<string, DialogData>();  
        ...
        /// - Auto Load
        /// </summary>
        public static Dictionary<string, DialogData>  GetDictionary()
        {{
           if (isLoaded == false) Load();
...
#region fuctions
        ...
        public static void LoadFromGoogle(System.Action<List<DialogData>, Dictionary<string, DialogData>> onLoaded, bool updateCurrentData = false)
        {      
    ...
    public static (List<DialogData> list, Dictionary<string, DialogData> map) CommonLoad(Dictionary<string, Dictionary<string, List<string>>> jsonObject, bool forceReload){
            Dictionary<string, DialogData> Map = new Dictionary<string, DialogData>();
